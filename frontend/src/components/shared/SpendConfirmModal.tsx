        ...
        {insufficient ? (
          <>
            ...
            <div style={{ fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: 24 }}>
              You need <span style={{ color: '#F0A500', fontFamily: 'var(--font-display)' }}>{TOKENS_PER_GAME} tokens</span> to start a game but your balance is <span style={{ color: '#FF4D6A', fontFamily: 'var(--font-display)' }}>{balance}</span>.
            </div>
